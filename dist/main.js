...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"allProjects\": () => (/* binding */ allProjects),\n/* harmony export */   \"currentProject\": () => (/* binding */ currentProject),\n/* harmony export */   \"displayCurrentProjects\": () => (/* binding */ displayCurrentProjects)\n/* harmony export */ });\n/* harmony import */ var _todo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todo */ \"./src/todo.js\");\n/* harmony import */ var _domElements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./domElements */ \"./src/domElements.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ \"./src/utils.js\");\n/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./storage */ \"./src/storage.js\");\n/* harmony import */ var _creators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./creators */ \"./src/creators.js\");\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* eslint-disable eqeqeq */\n\n\n\n\n\n\n\n\nlet allProjects = []; // eslint-disable-line\nlet currentProject = ''; // eslint-disable-line\nlet currentTodo = '';\n\nconst displayCurrentProjects = (currentProject) => { // eslint-disable-line\n  if (currentProject == '') {\n    currentProject = _domElements__WEBPACK_IMPORTED_MODULE_1__.selectProject.value; // eslint-disable-line\n  }\n\n  allProjects.forEach((project) => {\n    if (project.projectName === currentProject) {\n      _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.removeMsg();\n      _domElements__WEBPACK_IMPORTED_MODULE_1__.todoLists.innerHTML = '';\n      if (project.todoList.length > 0) {\n        for (let i = 0; i < project.todoList.length; i += 1) {\n          const todoDiv = document.createElement('div');\n          (0,_utils__WEBPACK_IMPORTED_MODULE_2__.priorityBg)(project.todoList[i].priority, todoDiv);\n          todoDiv.classList.add('todoDiv');\n\n          let todoString = `Title: ${project.todoList[i].title} </br>`;\n          todoString += `Description :${project.todoList[i].description} </br>`;\n          todoString += `DueDate :${project.todoList[i].dueDate} </br>`;\n          todoString += `Priority  :${project.todoList[i].priority} </br>`;\n          todoDiv.innerHTML = todoString;\n\n          const editBtn = document.createElement('button');\n          const deleteBtn = document.createElement('button');\n\n          editBtn.innerHTML = 'Edit';\n          deleteBtn.innerHTML = 'Delete';\n          editBtn.classList.add('editBtn');\n          deleteBtn.classList.add('deleteBtn');\n          editBtn.value = i;\n          deleteBtn.value = i;\n          todoDiv.appendChild(editBtn);\n          todoDiv.appendChild(deleteBtn);\n          _domElements__WEBPACK_IMPORTED_MODULE_1__.todoLists.appendChild(todoDiv);\n          _domElements__WEBPACK_IMPORTED_MODULE_1__.mainContent.appendChild(_domElements__WEBPACK_IMPORTED_MODULE_1__.todoLists);\n        }\n      } else {\n        _domElements__WEBPACK_IMPORTED_MODULE_1__.todoListDetails.innerHTML = 'no todo list!';\n      }\n    }\n  });\n};\n\nconst initialLoad = () => {\n  allProjects = (0,_storage__WEBPACK_IMPORTED_MODULE_3__.getProjects)();\n  (0,_utils__WEBPACK_IMPORTED_MODULE_2__.selectOption)(allProjects);\n  displayCurrentProjects(currentProject);\n};\n\nconst validateProjectInput = (event) => {\n  event.preventDefault();\n  if (_domElements__WEBPACK_IMPORTED_MODULE_1__.projectName.value === '') {\n    _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.errorMsgsAlert('Project Name can not be empty');\n  } else {\n    (0,_creators__WEBPACK_IMPORTED_MODULE_4__.createProjectName)(_domElements__WEBPACK_IMPORTED_MODULE_1__.projectName.value, allProjects);\n  }\n};\n\nconst validateTodoInput = (event) => {\n  event.preventDefault();\n  if (_domElements__WEBPACK_IMPORTED_MODULE_1__.todoTitle.value === '') {\n    _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.errorMsgsAlert('Title can not be empty');\n  } else {\n    (0,_creators__WEBPACK_IMPORTED_MODULE_4__.createTodoObject)(_domElements__WEBPACK_IMPORTED_MODULE_1__.todoTitle.value, _domElements__WEBPACK_IMPORTED_MODULE_1__.todoDescription.value, _domElements__WEBPACK_IMPORTED_MODULE_1__.todoDueDate.value, _domElements__WEBPACK_IMPORTED_MODULE_1__.todoPriority.value,\n      currentProject, allProjects);\n    document.getElementById('dropDownProject').reset();\n  }\n};\n\nconst deleteTodo = (target) => {\n  allProjects.forEach((proj) => {\n    if (proj.projectName === currentProject) {\n      proj.todoList.splice(target.value, 1);\n      (0,_storage__WEBPACK_IMPORTED_MODULE_3__.saveProjects)(allProjects);\n      displayCurrentProjects(currentProject);\n    }\n  });\n};\n\nconst showEditTodoForm = (target) => {\n  _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.showTodoForm();\n  _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.hideSubmitTodo();\n  allProjects.forEach((proj) => {\n    if (proj.projectName === currentProject) {\n      const temp = proj.todoList[target.value];\n      _domElements__WEBPACK_IMPORTED_MODULE_1__.todoTitle.value = temp.title;\n      _domElements__WEBPACK_IMPORTED_MODULE_1__.todoDescription.value = temp.description;\n      _domElements__WEBPACK_IMPORTED_MODULE_1__.todoDueDate.value = temp.dueDate;\n      _domElements__WEBPACK_IMPORTED_MODULE_1__.todoPriority.value = temp.priority;\n      currentTodo = target.value;\n    }\n  });\n};\n\nconst editTodoObject = () => {\n  _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.showSubmitTodo();\n  _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.hideTodoForm();\n  allProjects.forEach((proj) => {\n    if (proj.projectName === currentProject) {\n      const editedTodo = (0,_todo__WEBPACK_IMPORTED_MODULE_0__.default)(_domElements__WEBPACK_IMPORTED_MODULE_1__.todoTitle.value, _domElements__WEBPACK_IMPORTED_MODULE_1__.todoDescription.value, _domElements__WEBPACK_IMPORTED_MODULE_1__.todoDueDate.value, _domElements__WEBPACK_IMPORTED_MODULE_1__.todoPriority.value); // eslint-disable-line \n      proj.todoList[currentTodo] = editedTodo;// eslint-disable-line \n      const objIndex = allProjects.findIndex(((obj) => obj.projectName == currentProject));\n      allProjects[objIndex] = proj;\n      (0,_storage__WEBPACK_IMPORTED_MODULE_3__.saveProjects)(allProjects);\n      displayCurrentProjects(currentProject);\n    }\n  });\n};\n\nconst btnListner = (targetBtn) => {\n  if (targetBtn.classList == 'editBtn') {\n    showEditTodoForm(targetBtn);\n  } else if (targetBtn.classList == 'deleteBtn') {\n    deleteTodo(targetBtn);\n  }\n};\n\ninitialLoad();\n\n_domElements__WEBPACK_IMPORTED_MODULE_1__.addProjectBtn.onclick = () => {\n  _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.showProjectForm();\n};\n\n_domElements__WEBPACK_IMPORTED_MODULE_1__.toDoBtn.onclick = () => {\n  _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.showTodoForm();\n};\n\n_domElements__WEBPACK_IMPORTED_MODULE_1__.createProject.onclick = (event) => {\n  validateProjectInput(event);\n};\n\n_domElements__WEBPACK_IMPORTED_MODULE_1__.submitTodo.onclick = (event) => {\n  validateTodoInput(event);\n};\n\n_domElements__WEBPACK_IMPORTED_MODULE_1__.cancelProject.onclick = (event) => {\n  event.preventDefault();\n  _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.hideProjectForm();\n};\n\n//\n_domElements__WEBPACK_IMPORTED_MODULE_1__.cancelTodo.onclick = (ev) => {\n  ev.preventDefault();\n  _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.hideTodoForm();\n  _domElements__WEBPACK_IMPORTED_MODULE_1__.domObjects.showSubmitTodo();\n};\n\n_domElements__WEBPACK_IMPORTED_MODULE_1__.editTodo.onclick = (ev) => {\n  ev.preventDefault();\n  editTodoObject();\n};\n\n_domElements__WEBPACK_IMPORTED_MODULE_1__.todoLists.addEventListener('click', (e) => {\n  btnListner(e.target);\n});\n\n_domElements__WEBPACK_IMPORTED_MODULE_1__.selectProject.onchange = () => {\n  currentProject = _domElements__WEBPACK_IMPORTED_MODULE_1__.selectProject.value;\n  displayCurrentProjects(currentProject);\n};\n\n\n\n//# sourceURL=webpack://todo_app/./src/index.js?");
